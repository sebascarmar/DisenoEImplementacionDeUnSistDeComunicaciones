...
plt.suptitle('Constellation Diagrams | SNR={} dB (fixed sim.)'.format(SNR_db), fontsize=18)
plt.subplot(1,2,1)
...
plt.suptitle('DSP input and output | SNR={} dB (fixed sim.)'.format(SNR_db), fontsize=18)
plt.subplot(2,1,1)
...
plt.suptitle(f'Re{"{FSE Taps}"} Bode | SNR={SNR_db} dB (fixed sim.)', fontsize=18)
...
plt.suptitle(f'Re{"{FSE Taps}"} | SNR={SNR_db} dB (fixed sim.)', fontsize=18)
...
plt.suptitle(f'Decimated Re{"{FSE Taps}"} | SNR={SNR_db} dB (fixed sim.)', fontsize=18)
plt.xlabel('Time [n]',fontsize=15)
plt.ylim(-1.5, 4.0)
plt.xticks(fontsize=14)
plt.yticks(fontsize=14)
