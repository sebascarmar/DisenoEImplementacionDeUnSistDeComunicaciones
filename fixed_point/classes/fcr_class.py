...
class fcr_class:
    ...
    def __init__(self, Kp, Ki, NSYM_FCR_ON):
        ...
        self.symI_out       = DeFixedInt(12, 9, 'S', 'trunc', 'saturate')
        self.symQ_out       = DeFixedInt(12, 9, 'S', 'trunc', 'saturate')
        self.symI_out.value = 0.0
        self.symQ_out.value = 0.0
        # Va a depender de la cuantización del error en LMS/FSE
        self.errI_unrot       = DeFixedInt(12, 9, 'S', 'trunc', 'saturate')
        self.errQ_unrot       = DeFixedInt(12, 9, 'S', 'trunc', 'saturate')
