...
ch_symI_ch_filt_from_ver = np.loadtxt("file_ch_symI_chfilt.txt", dtype=np.intp)
ch_symQ_ch_filt_from_ver = np.loadtxt("file_ch_symQ_chfilt.txt", dtype=np.intp)
#convierte al valor correspondiente al formato de punto fijo S(8.7)
frac_bits = 7
ch_symI_ch_filt = ch_symI_ch_filt_from_ver / (2**frac_bits)
ch_symQ_ch_filt = ch_symQ_ch_filt_from_ver / (2**frac_bits)
print("Fragmento de salidas del filtro de canal de I y Q")
print(ch_symI_ch_filt[19:29])
print(ch_symQ_ch_filt[19:29])
