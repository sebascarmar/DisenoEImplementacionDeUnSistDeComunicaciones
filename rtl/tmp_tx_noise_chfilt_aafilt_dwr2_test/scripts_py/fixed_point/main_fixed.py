...
frac_bits = 7
rx_symI_dw_r2_v = rx_symI_dw_r2_from_ver / (2**frac_bits)
rx_symQ_dw_r2_v = rx_symQ_dw_r2_from_ver / (2**frac_bits)
print("Fragmento de salidas del dwsamp tasa2 I y Q")
print(rx_symI_dw_r2_v[0:50])
print(rx_symQ_dw_r2_v[0:50])
...
#    #print("errQ",     coeff_err_Q.fValue)
    ...
    print("tapI",     hex(int((fse.get_coeffI()[5]*2**25))))
    #print("tapI",     bin(int((fse.get_coeffI()[1]*2**25))))
    print("tapI", format((int((fse.get_coeffI()[1]*2**25))) & (2**28 - 1), '#0{}x'.format(28//4 + 2)))
...
print(RX_SYMI_DW_RATE1_LOG[0:50])
