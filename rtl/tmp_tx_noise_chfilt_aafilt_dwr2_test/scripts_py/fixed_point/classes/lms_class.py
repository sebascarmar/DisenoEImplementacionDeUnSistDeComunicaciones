...
#                print("shiI", shftrI[i])
#                print("shiQ", shftrQ[i])
#                print("term1I", self.term1_I.fValue)
#                print("term2Q", self.term2_I.fValue)
#                print("term1I", self.term1_Q.fValue)
#                print("term2Q", self.term2_Q.fValue)
#                print("new_tapI", new_tapsI[i])
#                print("new_tapQ", new_tapsQ[i])
#                input()
...
#        print("shiI",     shftrI)
#        print("shiQ",     shftrQ)
#        print("new_tapI", new_tapsI)
#        print("new_tapQ", new_tapsQ)
        #input()

        print("LMS shftrI:", shftrI)
        print("LMS new tapsI:", new_tapsI)
