...
sim_data     = np.loadtxt("file_sim_data.txt", dtype=np.intp)
...
#### Downsampler (rate 2)
rx_symI_dw_r2_from_ver = np.loadtxt("file_rx_symI_dwr2.txt", dtype=np.intp)
rx_symQ_dw_r2_from_ver = np.loadtxt("file_rx_symQ_dwr2.txt", dtype=np.intp)
...
#### FSE Out
rx_symI_fse_from_ver = np.loadtxt("file_rx_symI_fse.txt", dtype=np.intp)
rx_symQ_fse_from_ver = np.loadtxt("file_rx_symQ_fse.txt", dtype=np.intp)
...
#### Downsampler (rate 1)
rx_symI_dw_r1_from_ver = np.loadtxt("file_rx_symI_dwr1.txt", dtype=np.intp)
rx_symQ_dw_r1_from_ver = np.loadtxt("file_rx_symQ_dwr1.txt", dtype=np.intp)
