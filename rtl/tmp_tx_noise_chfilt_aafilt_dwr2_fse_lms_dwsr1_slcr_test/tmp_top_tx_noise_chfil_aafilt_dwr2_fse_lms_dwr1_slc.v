...
`define NUM_FSE_TAPS 11
`define NBT_FSE_TAPS 28
`define NBF_FSE_TAPS 25
`define NBT_FSE_OUT  12
`define NBF_FSE_OUT   9
`define NBT_TAPS_ERR 12
`define NBF_TAPS_ERR  9

module tmp_top_tx_noise_chfil_aafilt_dwr2_fse_lms_dwr1_slc
#(
 ...
 (
  ...
  // temporales
  output signed [NBT_FSE_OUT-1:0] symI_slcr,
  output signed [NBT_FSE_OUT-1:0] symQ_slcr,
  ...
  wire signed [NBT_FSE_OUT-1:0] o_os_data_I;
  wire signed [NBT_FSE_OUT-1:0] o_os_data_Q;
  adaptive_filter #(
    .STEP    (LMS_STEP      ),
    .LEAK    (LMS_LEAK      ),
    ...
    .i_is_data_I(w_dw_r2I_to_fse),
    .i_is_data_Q(w_dw_r2Q_to_fse),
  ...
  assign symI_slcr = o_os_data_I;
  assign symQ_slcr = o_os_data_Q;
