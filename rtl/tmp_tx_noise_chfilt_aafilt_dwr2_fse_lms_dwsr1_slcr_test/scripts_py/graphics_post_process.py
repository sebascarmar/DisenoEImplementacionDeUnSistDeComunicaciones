...
###### Downsampler (rate 2)
#rx_symI_dw_r2 = np.loadtxt('rx_symI_dw_rate2.txt', delimiter=',')
#rx_symQ_dw_r2 = np.loadtxt('rx_symQ_dw_rate2.txt', delimiter=',')
...
frac_bits=9
rx_symI_fse = rx_symI_fse_from_ver / (2**frac_bits)
rx_symQ_fse = rx_symQ_fse_from_ver / (2**frac_bits)
##### FCR
...
rx_symI_dw_r1_from_ver = np.loadtxt('file_rx_symI_dwr4.txt', delimiter=',')
rx_symQ_dw_r1_from_ver = np.loadtxt('file_rx_symQ_dwr4.txt', delimiter=',')
frac_bits=9
rx_symI_dw_r1 = rx_symI_dw_r1_from_ver / (2**frac_bits)
rx_symQ_dw_r1 = rx_symQ_dw_r1_from_ver / (2**frac_bits)
###### Slicer
...
rx_symI_slcr_from_ver = np.loadtxt('file_rx_symI_slcr.txt', delimiter=',')
rx_symQ_slcr_from_ver = np.loadtxt('file_rx_symQ_slcr.txt', delimiter=',')
frac_bits=9
rx_symI_slcr = rx_symI_slcr_from_ver / (2**frac_bits)
rx_symQ_slcr = rx_symQ_slcr_from_ver / (2**frac_bits)
###### Demapper
...
print(rx_symI_slcr[0:50])
#print(rx_symQ_slcr[0:50])
